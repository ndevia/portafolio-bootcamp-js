...
Este proyecto fue desarrollado como parte del Bootcamp Desarrollo de Aplicaciones Full Stack JavaScript como ejercicio de evaluación de portafolio al final del segundo módulo. Su objetivo principal es poner en práctica los conocimientos adquiridos a la fecha y dar forma a nuestro portafolio de proyectos, utilizando:
